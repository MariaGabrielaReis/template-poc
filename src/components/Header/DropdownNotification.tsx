  ...
  return (
    <li className="relative">
      <Link
        ...
        href="#"
        className="hover:text-brand bg-graylight relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke"
      >
        <span
        ...
        <svg
          className="text-brand fill-current duration-300 ease-in-out"
          width="18"
          height="18"
          viewBox="0 0 18 18"
          fill="none"
      ...
      >
        <div className="px-4.5 py-3">
          <h5 className="text-sm font-medium text-gray">Notification</h5>
        </div>

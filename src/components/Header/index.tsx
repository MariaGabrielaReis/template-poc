...
export function Header({
  ...
  return (
    <header className="bg-brand sticky top-0 z-999 flex w-full drop-shadow-1">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4">
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke bg-transparent p-1.5 shadow-sm"
          >
          ...
          <Link className="block flex-shrink-0 font-bold text-white" href="/">
            {/* <Image
              width={32}
              height={32}
        ...
        <Searchbar>
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="border-brand relative border border-b-white pb-2">
              <SearchButton>
                <svg
              ...
              <SearchbarInput
                type="text"
                placeholder="Digite um nome ou conta"
              />
            </div>
          </form>
        </Searchbar>

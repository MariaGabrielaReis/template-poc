              ...
              <form>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="focus:border-brand dark:focus:border-brand w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white"
                    />
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="focus:border-brand dark:focus:border-brand w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-white outline-none focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white"
                    />
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="Sign In"
                    className="border-brand bg-brand w-full cursor-pointer rounded-lg border p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>

                <button className="bg-graylight flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-graydark dark:hover:bg-opacity-50">
                  <span>
                    <svg
                      width="20"
                      height="20"
